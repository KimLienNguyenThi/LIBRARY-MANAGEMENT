...
public class Dialog_ThemThanhVien extends JDialog {
	...
	public void init() {
		...
		label_MaDocGia_DialogTTV.setFont(new Font("Times New Roman", Font.BOLD, 19));
		...
		label_MaThe__DialogTTV.setFont(new Font("Times New Roman", Font.BOLD, 19));
		...
		label_NgayDK_DialogTTV.setFont(new Font("Times New Roman", Font.BOLD, 14));
		...
		label_HanThe_DialogTTV.setFont(new Font("Times New Roman", Font.BOLD, 14));
		...
		label_PhiDK_DialogTTV.setFont(new Font("Times New Roman", Font.BOLD, 14));
